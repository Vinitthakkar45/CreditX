...
const ChatMessage: React.FC<ChatMessageProps> = ({
  ...
  return (
    ...
    >
      {isBot && (
        <Avatar className="h-8 w-8 bg-bureau-cibil/10 border border-bureau-cibil/20 backdrop-blur-sm">
      ...
      {!isBot && (
        <Avatar className="h-8 w-8 bg-bureau-cibil border border-white/10 backdrop-blur-sm">
