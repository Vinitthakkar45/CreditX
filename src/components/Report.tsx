  ...
  return (
    <main className="p-6 h-[calc(100vh-64px)] overflow-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <motion.div
          className="bg-black/30 backdrop-blur-sm border border-white/5 rounded-lg p-5 lg:col-span-2"
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-foreground/60 text-sm">Application ID: LOAN-2023-10-42857</p>
            </div>
          </div>
        ...
        <motion.div
          className="bg-black/30 backdrop-blur-sm border border-white/5 rounded-lg p-5"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="mt-4">
            <p className="text-sm text-foreground/70 mb-2">Decision Summary:</p>
            <p className="text-sm">{reportData["Justification for the Decision"].substring(0, 150)}...</p>
          </div>
        </motion.div>
      </div>
        ...
        <ReportSection title="Identified Risks" delay={0.4}>
          ...
          <div className="mt-4 p-3 bg-status-rejected/10 border border-status-rejected/20 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-status-rejected mb-1">High Risk Factors</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <ReportSection title="Risk Mitigation" delay={0.6}>
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-sm">{reportData["Risk Mitigation Suggestions"]}</p>
          </div>
          ...
          <div className="p-3 bg-status-approved/10 border border-status-approved/20 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-status-approved mb-1">Recommended Actions</h4>
                <ul className="list-disc pl-4 text-sm space-y-1">
